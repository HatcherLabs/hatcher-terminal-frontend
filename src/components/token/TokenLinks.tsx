        ...
        <div className="flex items-center justify-center gap-2">
          {twitter && (
            <a
              ...
              onMouseEnter={(e) => { e.currentTarget.style.color = "#1DA1F2"; e.currentTarget.style.borderColor = "rgba(29,161,242,0.3)"; e.currentTarget.style.boxShadow = "0 0 6px rgba(34,197,94,0.1)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.color = "#8890a4"; e.currentTarget.style.borderColor = "rgba(34,197,94,0.08)"; e.currentTarget.style.boxShadow = "none"; }}
            >
          ...
          {telegram && (
            <a
              ...
              className="flex items-center justify-center h-9 px-3 rounded-lg text-xs font-medium transition-colors"
              style={{ background: "#141820", border: "1px solid rgba(34,197,94,0.08)", color: "#8890a4" }}
              onMouseEnter={(e) => { e.currentTarget.style.color = "#229ED9"; e.currentTarget.style.borderColor = "rgba(34,158,217,0.3)"; e.currentTarget.style.boxShadow = "0 0 6px rgba(34,197,94,0.1)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.color = "#8890a4"; e.currentTarget.style.borderColor = "rgba(34,197,94,0.08)"; e.currentTarget.style.boxShadow = "none"; }}
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="mr-1.5">
          ...
          {website && (
            <a
              ...
              className="flex items-center justify-center h-9 px-3 rounded-lg text-xs font-medium transition-colors"
              style={{ background: "#141820", border: "1px solid rgba(34,197,94,0.08)", color: "#8890a4" }}
              onMouseEnter={(e) => { e.currentTarget.style.color = "#22c55e"; e.currentTarget.style.borderColor = "rgba(34,197,94,0.3)"; e.currentTarget.style.boxShadow = "0 0 6px rgba(34,197,94,0.1)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.color = "#8890a4"; e.currentTarget.style.borderColor = "rgba(34,197,94,0.08)"; e.currentTarget.style.boxShadow = "none"; }}
            >
      ...
      <div className="flex items-center justify-center gap-2">
        {[
          ...
          <a
            ...
            style={{ background: "#141820", border: "1px solid rgba(34,197,94,0.08)", color: "#8890a4" }}
            onMouseEnter={(e) => { e.currentTarget.style.color = link.hoverColor; e.currentTarget.style.borderColor = `${link.hoverColor}4d`; e.currentTarget.style.boxShadow = "0 0 6px rgba(34,197,94,0.1)"; }}
            onMouseLeave={(e) => { e.currentTarget.style.color = "#8890a4"; e.currentTarget.style.borderColor = "rgba(34,197,94,0.08)"; e.currentTarget.style.boxShadow = "none"; }}
