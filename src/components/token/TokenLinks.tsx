...
export function TokenLinks({ mintAddress, twitter, telegram, website }: TokenLinksProps) {
  return (
    <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center justify-center gap-2">
          {twitter && (
            <a
              ...
              onMouseLeave={(e) => { e.currentTarget.style.color = "#9ca3b8"; e.currentTarget.style.borderColor = "#1a1f2e"; }}
            >
      ...
      <div className="flex items-center justify-center gap-2">
        {[
          { label: "PF", title: "Pump.fun", url: `https://pump.fun/coin/${mintAddress}`, hoverColor: "#00d672" },
          { label: "SS", title: "Solscan", url: `https://solscan.io/token/${mintAddress}`, hoverColor: "#3b82f6" },
          { label: "BE", title: "Birdeye", url: `https://birdeye.so/token/${mintAddress}?chain=solana`, hoverColor: "#f0a000" },
          { label: "DS", title: "DexScreener", url: `https://dexscreener.com/solana/${mintAddress}`, hoverColor: "#00d672" },
        ].map((link) => (
          <a
            key={link.label}
            href={link.url}
