...
export default function RootError({
  ...
  return (
    ...
    >
      ...
      >
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#f23645" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <h1 className="text-xl font-bold mb-2" style={{ color: "#eef0f6" }}>
        Critical Error
      </h1>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <button
          ...
          style={{ background: "#10131c", color: "#9ca3b8", border: "1px solid #1a1f2e" }}
        >
          Go Home
        </button>
      </div>
      ...
      {showDetails && (
        ...
        >
          <p className="text-[11px] font-mono break-all leading-relaxed" style={{ color: "#f23645" }}>
            {error.message}
          </p>
          {error.digest && (
            <p className="text-[10px] font-mono mt-2" style={{ color: "#363d54" }}>
              Digest: {error.digest}
            </p>
          )}
        </div>
